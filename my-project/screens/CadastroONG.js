...
export default function CadastroONG({route,navigation}){
...
<Input  leftIcon={<Icon name='user'size={24} color='black'/>} style={{width:"300px"}} placeholder={' CNPJ'}/>
<Input  leftIcon={<Icon name='user'size={24} color='black'/>} style={{width:"300px"}} placeholder={' Nome'}/>
